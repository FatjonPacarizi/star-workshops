...
<div class="w-full h-full p-6  flex flex-col  items-center">
    ...
    <div class="w-full bg-white border border-gray-200 rounded pb-4 mt-12">
        ...
        <tr class='bg-gray-100'>
          ...
          <td>
            <a href="{{ url('edit-landing/'.$item->id) }}" class="bg-sky-500 text-white px-4 py-1 text-sm rounded m-3">   <span class="inline-flex items-center justify-center h-6 w-6"><i class="mdi mdi-pencil-outline inline-flex"></i></span>
            Edit</a>
          </td>
