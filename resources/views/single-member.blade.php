...
<section class="w-full text-white body-font">
  <div class=" w-full flex flex-wrap  py-24 justify-between items-center ">
    <div class=" md:w-1/2 lg:px-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center text-black ">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium ">{{ $staffMembers->name }}
      </h1>
      <p class="mb-8 leading-relaxed">{!! $staffMembers->email !!}</p>
      <p class="mb-8 leading-relaxed">{!! $staffMembers->description !!}</p>
      <div class="flex justify-center">
      <div class="flex h-10 mt-5 ">
      <a class="" href="{{$staffMembers->instagram}}" target="_blank"><i class="fa-brands fa-instagram fa-2xl"
                        style="color:red"></i></a>
