...
<div class="p-6 flex flex-col w-full mt-12 items-center">
    ...
    <div class="w-full bg-white border border-gray-200 rounded">
        ...
        @endif
        <form action="{{ url('add-landing') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="w-full p-2 flex justify-end border-t border-gray-200">
                <button type="submit" class="rounded py-2 px-5 bg-blue-800 text-white hover:bg-blue-900">Add Landing</button>
            </div>
        </form>
