        ...
        <div class="flex items-center justify-around mb-4">
            ...
            <div class="flex items-center justify-between rounded-xl flex-wrap p-4 bg-white" style = "box-shadow: rgba(0, 0, 0, 0.1) 50px 20px 100px;">
                ...
                <div>
                    <div class="px-2 py-2.5 rounded-lg ml-2 text-white bg-gradient-to-r from-purple-500 to-pink-500 shadow-md">   
                         <i class="mdi mdi-account-outline mx-1 fa-xl"></i>
                    </div>
            ...
            <div class="w-1/4 px-3">
                <div class=" flex items-center justify-between rounded-xl flex-wrap p-4 bg-white" style = "box-shadow: rgba(0, 0, 0, 0.1) 0px 20px 80px;">
                   ...
                   <div>
                       <div class="px-2 py-2.5 rounded-lg ml-2 text-white bg-gradient-to-r from-purple-500 to-pink-500 shadow-md">   
                           <i class="mdi mdi-widgets inline-flex mx-1 fa-xl"></i>
                       </div>
             ...
             <div class=" flex items-center justify-between rounded-xl flex-wrap p-4 bg-white" style = "box-shadow: rgba(0, 0, 0, 0.1) 0px 20px 80px;">
                <div class = "">
                    ...
                    <h2 class = "text-black text-xl font-bold flex items-center">{{$usersThisMonthRegistered}}  <span class = "text-xs text-green-400 ml-3">+{{$usersThisMonthRegistered/$users*100}}% more last 30 days</span></h2>
                </div>
                <div>
                    <div class="px-2 py-2.5 rounded-lg ml-2 text-white bg-gradient-to-r from-purple-500 to-pink-500 shadow-md">   
                         <i class="mdi mdi-account-outline mx-1 fa-xl"></i>
             ...
             <div class="flex items-center justify-between rounded-xl flex-wrap p-4 bg-white" style = "box-shadow: rgba(0, 0, 0, 0.1) 0px 20px 80px;">
                <div class = "">
                    <p>Workshops this month</p>
                    <h2 class = "text-black text-xl font-bold flex items-center">{{$workshopsThisMonthRegistered}}  <span class = "text-xs text-green-400 ml-3">+{{$workshopsThisMonthRegistered/$totalWorkshops*100}}% more last 30 days</span></h2>
                </div>
                <div>
                    <div class="px-2 py-2.5 rounded-lg ml-2 text-white bg-gradient-to-r from-purple-500 to-pink-500 shadow-md">   
                        <i class="mdi mdi-widgets inline-flex mx-1 fa-xl"></i>
