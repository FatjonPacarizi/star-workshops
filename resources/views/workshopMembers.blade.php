...
<section class="flex flex-wrap justify-center relative bg-[#f2f2f2]">
    <div class="flex flex-wrap lg:mx-4 pt-16 pb-16 justify-center w-4/5">
        ...
        <div class="w-full h-fit md:w-2/5 lg:w-1/4 p-6 bg-white md:ml-16 rounded-3xl mt-10">
            <img class="w-full object-cover rounded-tl-lg rounded-tr-lg p-5"
                src="{{$staffMember->profile_photo_path ? asset('/storage/' . $staffMember->profile_photo_path) : asset('img/defaultuserphoto.png') }}"
                alt="" />
            ...
            <div class="flex h-10 mt-5 ">
                <a href="{{$staffMember->instagram}}" target="_blank"><i class="fa-brands fa-instagram fa-2xl"
                        style="color:red"></i></a>
                <a href="{{$staffMember->facebook}}" target="_blank"><i class="fa-brands fa-facebook fa-2xl mx-4"
                        style="color:red"></i></a>
                <a href="{{$staffMember->github}}" target="_blank"><i class="fa-brands fa-github fa-2xl"
                        style="color:red"></i></a>
            </div>
        </div>
        @endforeach
