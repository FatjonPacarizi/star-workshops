  ...
  <div class="w-full lg:w-4/5">
    ...
    <div class="w-full border flex flex-wrap   ">
      @foreach($upcomings as $upcoming)
        <div class="w-full relative rounded shadow-lg m-10  bg-white  sm:w-2/5 sm:mx-auto  lg:w-3/12 lg:mx-7">
...
<section class="w-full pt-6 flex flex-col items-center  bg-white">
    ...
    <div class="w-full  mx-auto flex flex-wrap   lg:w-4/5 lg:justify-between">
