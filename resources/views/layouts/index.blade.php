        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <div class="w-full flex justify-left items-left m-3">
                <div class="p-6 flex h-fit bg-white w-full " >
                    <div class="txt items-center border-r border-indigo-500">
                    ...
                    <div class="    ">
                        <div class="flex text-center justify-around p-6 max-w-sm bg-white">
                        ...
                        <div class="txt border-r border-indigo-500">
