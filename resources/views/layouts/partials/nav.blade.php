        ...
        <nav x-data="{ open: false }">
            <div class="flex justify-between items-center px-5 py-3">
                <div class="flex items-center">
                    <button id="mobile-menu-button"
                        class="text-gray-700 w-10 h-10 mr-2 relative focus:outline-none bg-white outline-none  md:block lg:hidden"
                        @click="open = !open">
                        <div class=" w-5">
                            <span aria-hidden="true"
                                class="absolute h-0.5 w-5 bg-current transform transition duration-500 ease-in-out"
                    ...
                    <a href="{{ route('landing' ) }}">
                        ...
                        @endphp
                        <img class="h-8 md:h10 md:m-3 mr-0  " alt="Logo"
                        ...
                        <x-jet-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button>
                                    ...
                                    <p
                                        class="w-4 h-4 text-xs mr-3 text-white absolute top-0 right-0 flex justify-center items-center rounded-full bg-red-400">
                            ...
                            <x-slot name="trigger">
                                ...
                                <div class="flex items-center">
                                    <button
                                        ...
                                        <img class="h-8 w-8 rounded-full object-cover shadow"
                                            src="{{Auth::user()->profile_photo_path ? asset('/storage/' . Auth::user()->profile_photo_path) : asset('img/defaultuserphoto.png') }}"
                                            alt="{{ Auth::user()->name}}" />
                                ...
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white hover:text-white focus:outline-none transition">
                                        {{ Auth::user()->name }}
            ...
            <div class="z-40" x-show="open" @click.outside="open = false">
                <ul class="bg-white text-black w-full">
                    <li><a href="{{route('workshops')}}"
                            class="font-bold block text-sm flex justify-center py-4 text-sm  hover-2"
                            aria-current="page">WORKSHOPS</a></li>
                    <li><a href="/newspage"
                            class="font-bold block text-sm flex justify-center py-4 text-sm hover-2">NEWS</a></li>
                    <li><a href="/members"
                            class="font-bold block text-sm flex justify-center py-4 text-sm hover-2">MEMBERS</a></li>
