  ...
  <table class="w-full " wire:loading.remove>
    ...
    <tr class='border-t border-gray-200'>
      ...
      <td class="flex items-center ">
          <button class="bg-sky-500 text-white px-3 p-2  text-xs rounded mr-3 my-2 hover:bg-blue-500 opacity-1" wire:click = 'restore({{$workshop1->id}})'>
            <i class="fa-solid fa-trash-can-arrow-up"></i>
            Restore
          </button>
           <button class="bg-red-500 text-white p-2 text-xs rounded mr-3 hover:bg-red-600" wire:click = 'forceDelete({{$workshop1->id}})'>
            <i class="fa-solid fa-trash-can  fa-md"></i>
            Force Delete
          </button>
        <a href="http://127.0.0.1:8000/pdf/{workshopid}" class="bg-sky-600 text-white px-3 p-2 text-xs rounded mr-3 my-2 hover:bg-blue-900 opacity-1"><i class="fa-regular fa-file-pdf"></i> Generate PDF</a>
      </td>
