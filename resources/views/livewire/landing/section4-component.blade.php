<div class="w-full  p-6 px-10 flex ">
    ...
    <div id = "flash-msg4" class="hidden absolute top-12 right-0" >
    ...
    <script src="{{ asset('js/tinymce/tinymce.js') }}"></script>
      <script>
        ...
        window.addEventListener('section4Update', event => {
            initTiny();
            document.getElementById("flash-msg4").style.display = "block";
            window.setTimeout( 
            function() {
                document.getElementById("flash-msg4").style.display = "none";
            }, 2500);
            });
      </script>
@endpush
