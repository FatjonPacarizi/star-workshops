      ...
      <div class="w-full flex items-center mb-4">
        ...
        <div class="mb-6 flex items-center">
            ...
            <div class="mb-6 flex items-center" wire:ignore>
                ...
                <div class="w-full mx-5">
                    <textarea wire:model.defer="paragraf_1" name="paragraf_1" id="paragraf_1s3" class="border border-gray-200 rounded p-1 w-full "></textarea>          
                    @error('paragraf_1')
                    <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                    @enderror
                </div>
            ...
            <div class="w-full p-4 flex justify-end ">
                ...
                <button wire:click.prevent = 'update({{$section3->id}})' class="rounded-lg py-2 px-6 text-blue-400 border-2 border-blue-400 hover:bg-blue-400 hover:text-white hover:border-blue-400 duration-300">Update </button>
            </div>
    </div>
    <div id = "flash-msg3" class="hidden absolute top-12 right-0" >
...
@push('scripts')
    <script src="{{ asset('js/tinymce/tinymce.js') }}"></script>
      <script>
        ...
        function initTiny(){
            tinymce.init({
            selector: '#paragraf_1s3', // Replace this CSS selector to match the placeholder element for TinyMCE
            height: 300,
            plugins: [
        ...
        window.addEventListener('section3Update', event => {
            initTiny();
            document.getElementById("flash-msg3").style.display = "block";
            window.setTimeout( 
            function() {
                document.getElementById("flash-msg3").style.display = "none";
            }, 2500);
            });
      </script>
@endpush
