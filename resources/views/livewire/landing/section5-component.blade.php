<div class="w-full p-10">
    <div class="w-full bg-white shadow-md  rounded-xl">
       ...
       <h1 class="p-3 text-black font-medium ml-2 ">Section 5 Edit</h1>
    </div>
<div class="w-full  p-6 px-10 flex ">
      ...
      <div class="w-full flex items-center mb-4">
        ...
        <div class="mb-6 flex items-center">
            ...
            <div class="mb-6 flex items-center" wire:ignore>
                ...
                <div class="w-full mx-5">
                    <textarea name="paragraf_1" wire:model.defer="paragraf_1" id="paragraf_1s5" class="border border-gray-200 rounded p-1 w-full "></textarea>          
                    @error('paragraf_1')
                    <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                    @enderror
                </div>
            ...
            <div class="mb-6  flex items-center">
                ...
                <img class="object-cover mx-5 rounded" alt="Image" src="{{$section5->img_1 ? asset('/storage/' . $section5->img_1) : asset('/img/section5_defaultimg.jpg')}}" width="100">
            </div>
    ...
    <div id = "flash-msg5" class="absolute top-1 -right-full z-40" >
...
@push('scripts')
    <script src="{{ asset('js/tinymce/tinymce.js') }}"></script>
      <script>
        ...
        function initTiny(){
            tinymce.init({
            selector: '#paragraf_1s5', // Replace this CSS selector to match the placeholder element for TinyMCE
            height: 300,
            plugins: [
