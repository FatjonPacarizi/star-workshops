...
<div class="w-full  p-6 px-10 flex my-10">
      ...
      <div class="w-full flex items-center mb-4">
        ...
        <div class="mb-6 flex items-center">
            ...
            <div role="status" wire:loading>
                ...
                <button wire:click.prevent = 'update({{$section2->id}})' class="rounded-lg py-2 px-6 text-blue-400 border-2 border-blue-400 hover:bg-blue-400 hover:text-white hover:border-blue-400 duration-300">Update </button>
            </div>
    </div>
</div>
</div>