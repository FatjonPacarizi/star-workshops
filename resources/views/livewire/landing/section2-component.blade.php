        ...
        <div class="w-full bg-white">
            ...
            <div class="mb-6 flex items-center">
                ...
                <div class="w-full mx-5">
                    <input type="text" name="heading" wire:model.defer="heading"
            ...
            <div class="mb-6 flex items-center" wire:ignore>
                ...
                <div class="w-full mx-5">
                    <textarea name="paragraf_1" wire:model.defer="paragraf_1" id="paragraf_1s2"
            ...
            <div class="w-full p-4 flex justify-end">
                ...
                <button wire:click.prevent='update({{$section2->id}})'
                    class="rounded-lg py-2 px-6 text-blue-400 border-2 border-blue-400 hover:bg-blue-400 hover:text-white hover:border-blue-400 duration-300">Update
                </button>
            </div>
        </div>
