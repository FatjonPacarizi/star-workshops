<div class = "flex items-end">
    <input type="text" wire:model="search" wire:keyup.debounce = "filter" class="text-slate-900 h-8 rounded my-3 text-xs border-b border-gray-400 ml-4" placeholder="Type to Search"  />
   
    
    <div class = "flex flex-col items-center">
        <p class = "text-xs">Sort By Status</p>
        <select wire:model="sortbystatus" wire:change = "filter" class="text-slate-900 rounded my-3 text-xs border-b border-gray-400 ml-4" >
            <option value = ""></option>
