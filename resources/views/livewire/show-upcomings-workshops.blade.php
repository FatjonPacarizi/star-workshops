<div class="w-full bg-white shadow  rounded-xl py-4 ">
    ...
    <tr class='border-t border-gray-200' style="border-top-width: 0.01em">
      ...
      <td>
        <div class=" relative flex items-center " x-data="{ open: false }">
          ...
          <ul class="bg-white absolute top-0 mt-2 z-10 shadow-lg border border-gray-100 rounded-lg w-40 py-1 " x-show="open"
            @click.outside="open = false">
            <li>
              <p class="text-xs pl-3 p-2 text-gray-400 ">Manage Workshop</p>
            </li>
            <li><a
                href="/workshopManage/{{$upcomingWorkshop->id}}/{{$upcomingWorkshop->limited_participants ? $upcomingWorkshop->limited_participants : 'null'}}/edit"
      ...
      <td>
        <a href={{ route('adminsuperadmin.showParticipants',$upcomingWorkshop->id)}} class="w-fit px-3 py-2
          ...
          <p
            ...
            {{$upcomingWorkshop->pendingParticipants}}</p>
          @endif
        </a>
      </td>
    </tr>
