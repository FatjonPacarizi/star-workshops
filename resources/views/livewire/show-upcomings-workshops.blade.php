<div class="w-full">
  ...
  <table class="w-full mx-auto" wire:loading.remove>
    ...
    <tr class='border-b border-gray-200'>
      ...
      @endphp
      <td class="w-32">
        <div class="w-6  flex justify-center items-start rounded text-white text-xs  @if($limited_participants) bg-orange-500 @else bg-green-500 @endif ">@if($limited_participants) {{$upcomingWorkshop->limited_participants}} @else no @endif</div>
      </td>
      ...
      <td class="flex items-center ">
        ...
        <a href={{ route('adminsuperadmin.showPDF',$upcomingWorkshop->id)}}><i class="fa-solid fa-file-arrow-down pl-1"></i></a>
      </td>
      <td>
