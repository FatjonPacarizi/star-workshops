                    ...
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="font-medium">@if($workshop_user[0]->application_status == 'approved' )<a href={{route('streaming',$str->id)}}>@endif <i class="fa-solid fa-circle-play text-red-600"></i>  {{$str->title }}</a></span>
                                    </div>
                                </td>
                       
                                <td class="py-3 px-6 text-center"><i class="fa fa-youtube-play"></i>
                                    <span class="bg-purple-200 text-purple-600 py-1 px-3 rounded-full text-xs">@if($workshop_user[0]->application_status == 'approved')<a href={{route('streaming',$str->id)}}>@endif Preview</a></span>
                                </td>
                            </tr> @endif
                            @endforeach
                        </tbody>
