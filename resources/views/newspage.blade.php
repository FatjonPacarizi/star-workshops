    ...
    <div class="flex flex-wrap -m-4">
      ...
      <div class="p-4 md:w-1/3">
        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          ...
          <div class="p-6">
            <h2 class="tracking-widest text-3xs title-font font-medium text-gray-500 mb-1">{{ $newspage->author }}</h2>
            <h1 class="title-font text-lg font-medium text-gray-900 mb-3">{{ $newspage->title }}</h1>
            <p class="leading-relaxed mb-3">{!! Illuminate\Support\Str::limit($newspage->description, 150, $end='...') !!}</p>
            <div class="flex items-center flex-wrap ">
              <a class="text-red-600 inline-flex items-center md:mb-2 lg:mb-0" href = "{{route('single-news',$newspage->id)}}">Learn More
